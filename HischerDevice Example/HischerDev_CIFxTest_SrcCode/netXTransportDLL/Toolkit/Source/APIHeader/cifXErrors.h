...
//  No Error
//
#define CIFX_NO_ERROR                    ((long)0x00000000L)
...
//
#define CIFX_INVALID_POINTER             ((long)0x800A0001L)
...
//
#define CIFX_INVALID_BOARD               ((long)0x800A0002L)
...
//
#define CIFX_INVALID_CHANNEL             ((long)0x800A0003L)
...
//
#define CIFX_INVALID_HANDLE              ((long)0x800A0004L)
...
//  Invalid parameter
//
#define CIFX_INVALID_PARAMETER           ((long)0x800A0005L)
...
//  Invalid command
//
#define CIFX_INVALID_COMMAND             ((long)0x800A0006L)
...
//  Invalid buffer size
//
#define CIFX_INVALID_BUFFERSIZE          ((long)0x800A0007L)
...
//  Invalid access size
//
#define CIFX_INVALID_ACCESS_SIZE         ((long)0x800A0008L)
...
//  Function failed
//
#define CIFX_FUNCTION_FAILED             ((long)0x800A0009L)
...
//
#define CIFX_FILE_OPEN_FAILED            ((long)0x800A000AL)
...
//  File size is zero
//
#define CIFX_FILE_SIZE_ZERO              ((long)0x800A000BL)
...
//
#define CIFX_FILE_LOAD_INSUFF_MEM        ((long)0x800A000CL)
...
//
#define CIFX_FILE_CHECKSUM_ERROR         ((long)0x800A000DL)
...
//
#define CIFX_FILE_READ_ERROR             ((long)0x800A000EL)
...
//  Invalid file type
//
#define CIFX_FILE_TYPE_INVALID           ((long)0x800A000FL)
...
//  Invalid file name
//
#define CIFX_FILE_NAME_INVALID           ((long)0x800A0010L)
...
//
#define CIFX_FUNCTION_NOT_AVAILABLE      ((long)0x800A0011L)
...
//
#define CIFX_BUFFER_TOO_SHORT            ((long)0x800A0012L)
...
//
#define CIFX_MEMORY_MAPPING_FAILED       ((long)0x800A0013L)
...
//
#define CIFX_NO_MORE_ENTRIES             ((long)0x800A0014L)
...
//
#define CIFX_CALLBACK_MODE_UNKNOWN       ((long)0x800A0015L)
...
//
#define CIFX_CALLBACK_CREATE_EVENT_FAILED ((long)0x800A0016L)
...
//
#define CIFX_CALLBACK_CREATE_RECV_BUFFER ((long)0x800A0017L)
...
//
#define CIFX_CALLBACK_ALREADY_USED       ((long)0x800A0018L)
...
//
#define CIFX_CALLBACK_NOT_REGISTERED     ((long)0x800A0019L)
...
//
#define CIFX_INTERRUPT_DISABLED          ((long)0x800A001AL)
...
//
#define CIFX_DRV_NOT_INITIALIZED         ((long)0x800B0001L)
...
//
#define CIFX_DRV_INIT_STATE_ERROR        ((long)0x800B0002L)
...
//
#define CIFX_DRV_READ_STATE_ERROR        ((long)0x800B0003L)
...
//
#define CIFX_DRV_CMD_ACTIVE              ((long)0x800B0004L)
...
//
#define CIFX_DRV_DOWNLOAD_FAILED         ((long)0x800B0005L)
...
//
#define CIFX_DRV_WRONG_DRIVER_VERSION    ((long)0x800B0006L)
...
//
#define CIFX_DRV_DRIVER_NOT_LOADED       ((long)0x800B0030L)
...
//
#define CIFX_DRV_INIT_ERROR              ((long)0x800B0031L)
...
//
#define CIFX_DRV_CHANNEL_NOT_INITIALIZED ((long)0x800B0032L)
...
//
#define CIFX_DRV_IO_CONTROL_FAILED       ((long)0x800B0033L)
...
//
#define CIFX_DRV_NOT_OPENED              ((long)0x800B0034L)
...
//
#define CIFX_DRV_DOWNLOAD_STORAGE_UNKNOWN ((long)0x800B0040L)
...
//
#define CIFX_DRV_DOWNLOAD_FW_WRONG_CHANNEL ((long)0x800B0041L)
...
//
#define CIFX_DRV_DOWNLOAD_MODULE_NO_BASEOS ((long)0x800B0042L)
...
//
#define CIFX_DEV_DPM_ACCESS_ERROR        ((long)0x800C0010L)
...
//
#define CIFX_DEV_NOT_READY               ((long)0x800C0011L)
...
//
#define CIFX_DEV_NOT_RUNNING             ((long)0x800C0012L)
...
//
#define CIFX_DEV_WATCHDOG_FAILED         ((long)0x800C0013L)
...
//
#define CIFX_DEV_SYSERR                  ((long)0x800C0015L)
...
//
#define CIFX_DEV_MAILBOX_FULL            ((long)0x800C0016L)
...
//  Send packet timeout
//
#define CIFX_DEV_PUT_TIMEOUT             ((long)0x800C0017L)
...
//
#define CIFX_DEV_GET_TIMEOUT             ((long)0x800C0018L)
...
//  No packet available
//
#define CIFX_DEV_GET_NO_PACKET           ((long)0x800C0019L)
...
//  Mailbox too short
//
#define CIFX_DEV_MAILBOX_TOO_SHORT       ((long)0x800C001AL)
...
//
#define CIFX_DEV_RESET_TIMEOUT           ((long)0x800C0020L)
...
//  COM-flag not set
//
#define CIFX_DEV_NO_COM_FLAG             ((long)0x800C0021L)
...
//
#define CIFX_DEV_EXCHANGE_FAILED         ((long)0x800C0022L)
...
//
#define CIFX_DEV_EXCHANGE_TIMEOUT        ((long)0x800C0023L)
...
//
#define CIFX_DEV_COM_MODE_UNKNOWN        ((long)0x800C0024L)
...
//
#define CIFX_DEV_FUNCTION_FAILED         ((long)0x800C0025L)
...
//
#define CIFX_DEV_DPMSIZE_MISMATCH        ((long)0x800C0026L)
...
//  Unknown state mode
//
#define CIFX_DEV_STATE_MODE_UNKNOWN      ((long)0x800C0027L)
...
//
#define CIFX_DEV_HW_PORT_IS_USED         ((long)0x800C0028L)
...
//
#define CIFX_DEV_CONFIG_LOCK_TIMEOUT     ((long)0x800C0029L)
...
//
#define CIFX_DEV_CONFIG_UNLOCK_TIMEOUT   ((long)0x800C002AL)
...
//
#define CIFX_DEV_HOST_STATE_SET_TIMEOUT  ((long)0x800C002BL)
...
//
#define CIFX_DEV_HOST_STATE_CLEAR_TIMEOUT ((long)0x800C002CL)
...
//
#define CIFX_DEV_INITIALIZATION_TIMEOUT  ((long)0x800C002DL)
...
//  Set Bus ON Timeout
//
#define CIFX_DEV_BUS_STATE_ON_TIMEOUT    ((long)0x800C002EL)
...
//  Set Bus OFF Timeout
//
#define CIFX_DEV_BUS_STATE_OFF_TIMEOUT   ((long)0x800C002FL)
...
//
#define CIFX_DEV_MODULE_ALREADY_RUNNING  ((long)0x800C0040L)
...
//
#define CIFX_DEV_MODULE_ALREADY_EXISTS   ((long)0x800C0041L)
...
//
#define CIFX_DEV_DMA_INSUFF_BUFFER_COUNT ((long)0x800C0050L)
...
//
#define CIFX_DEV_DMA_BUFFER_TOO_SMALL    ((long)0x800C0051L)
...
//
#define CIFX_DEV_DMA_BUFFER_TOO_BIG      ((long)0x800C0052L)
...
//
#define CIFX_DEV_DMA_BUFFER_NOT_ALIGNED  ((long)0x800C0053L)
...
//
#define CIFX_DEV_DMA_HANSHAKEMODE_NOT_SUPPORTED ((long)0x800C0054L)
...
//
#define CIFX_DEV_DMA_IO_AREA_NOT_SUPPORTED ((long)0x800C0055L)
...
//  Set DMA ON Timeout
//
#define CIFX_DEV_DMA_STATE_ON_TIMEOUT    ((long)0x800C0056L)
...
//  Set DMA OFF Timeout
//
#define CIFX_DEV_DMA_STATE_OFF_TIMEOUT   ((long)0x800C0057L)
...
//
#define CIFX_DEV_SYNC_STATE_INVALID_MODE ((long)0x800C0058L)
...
//
#define CIFX_DEV_SYNC_STATE_TIMEOUT      ((long)0x800C0059L)
...
//
#define CIFX_TRANSPORT_SEND_TIMEOUT      ((long)0x800D0001L)
...
//
#define CIFX_TRANSPORT_RECV_TIMEOUT      ((long)0x800D0002L)
...
//
#define CIFX_TRANSPORT_CONNECT           ((long)0x800D0003L)
...
// MessageText:
//
//  The translation layer provided by the device is not supported
//
...
//
#define CIFX_TRANSPORT_ERROR_UNKNOWN     ((long)0x800E0001L)
...
//
#define CIFX_TRANSPORT_CHECKSUM_ERROR    ((long)0x800E0002L)
...
//
#define CIFX_TRANSPORT_LENGTH_INCOMPLETE ((long)0x800E0003L)
...
//
#define CIFX_TRANSPORT_DATA_TYPE_UNKOWN  ((long)0x800E0004L)
...
//
#define CIFX_TRANSPORT_DEVICE_UNKNOWN    ((long)0x800E0005L)
...
//
#define CIFX_TRANSPORT_CHANNEL_UNKNOWN   ((long)0x800E0006L)
...
//
#define CIFX_TRANSPORT_SEQUENCE          ((long)0x800E0007L)
...
//
#define CIFX_TRANSPORT_BUFFEROVERFLOW    ((long)0x800E0008L)
...
//
#define CIFX_TRANSPORT_RESOURCE          ((long)0x800E0009L)
...
//
#define CIFX_TRANSPORT_KEEPALIVE         ((long)0x800E000AL)
...
//
#define CIFX_TRANSPORT_DATA_TOO_SHORT    ((long)0x800E000BL)
