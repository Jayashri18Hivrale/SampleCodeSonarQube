 ...
 *******************************************************************************
   ...
   Filename:
    $Id: HilTransport.h 2858 2011-09-09 10:55:34Z Holger $
   Last Modification:
    $Author: Holger $
    $Date: 2011-09-09 12:55:34 +0200 (Fr, 09 Sep 2011) $
    $Revision: 2858 $
   ...
   Changes:
     ...
     ---------------------------------------------------------------------------
      8         24.06.2009  MT       HIL_TRANSPORT_BASIC_FEATURES_U structure changed data type from 
...
#define HIL_TRANSPORT_TYPE_RCX_PACKET   0x0100          /**< Packet Type for transfering a RCX Packet           */
#define HIL_TRANSPORT_TYPE_MARSHALLER   0x0200          /**< Packet Type for function marshalling               */
#define HIL_TRANSPORT_TYPE_NETANA_MARSHALLER  0x0400   /**< Packet Type for function netANALYZER marshalling  */
