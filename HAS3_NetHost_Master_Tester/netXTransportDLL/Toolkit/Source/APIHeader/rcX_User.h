...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: rcX_User.h 3782 2012-08-08 09:23:06Z MichaelT $
  ...
  ---------------------------------------------------------------------------
    2012-08-03  MT            Added RCX_HW_DEV_CLASS_CHIP_NETX_52, RCX_HW_DEV_CLASS_NETSCADA_T50,
                              RCX_HW_DEV_CLASS_NETSMART_50, RCX_HW_DEV_CLASS_IOLINK_GW_51,
                              RCX_HW_DEV_CLASS_NETHMI_B500
    2012-07-23  MT            Changed RCX_MAX_PACKET_SIZE to 1596 Bytes (Comm. Channel Mailbox Size)
    2012-05-29  RM            Added DPM structure NETX_8K_DPM_COMM_CHANNEL
                              for hardware with only 8 KByte DPM (e.g. COMX10)
    2011-02-29  MS            Added RCX_HW_DEV_CLASS_GW_EU5C
    2012-01-31  RM            Added RCX_HW_DEV_CLASS_NETSCADA_T51,
