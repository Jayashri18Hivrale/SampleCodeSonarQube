...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: rcX_Public.h 3782 2012-08-08 09:23:06Z MichaelT $
  ...
  ---------------------------------------------------------------------------
    2012-07-17  BM            added RCX_GET_FW_PARAMETER_REQ and definitions
    2012-06-27  SS            added parameter id PID_BAUDRATE (RCX_SET_FW_PARAMETER_REQ)
    2012-03-28  RM            removed C++ comments, to prevent compiler warnings
    2012-02-13  MP            added RCX_SET_FW_PARAMETER_REQ and definitions
