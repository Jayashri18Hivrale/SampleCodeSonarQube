...
## How to integrate tested code into this library.

### Folder structure and its recommended usage:

```
dematic_modules
    |-- build            - All build-related files for the library, organized by compiler. 
    |-- include          - Library header files
    |-- lib              - Compiled libraries
    |-- src              - Library source files
    |-- tests
        |-- _build       - All build-related files for the test, organized by compiler.
